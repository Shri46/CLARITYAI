...
const Login = ({ setAuthUser }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 font-sans text-slate-200">
      <div className="absolute inset-0 bg-gradient-to-br from-teal-900/20 via-slate-950 to-indigo-900/20 z-0"></div>
      ...
      <div className="relative z-10 w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-2xl">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-gradient-to-tr from-teal-500 to-indigo-500 rounded-xl flex items-center justify-center text-white font-bold text-2xl mx-auto shadow-lg shadow-teal-500/30 mb-4">
            C
          </div>
          <h2 className="text-3xl font-bold text-white tracking-tight">Welcome Back</h2>
          <p className="text-slate-400 mt-2 text-sm">Sign in to access your financial dashboard</p>
        </div>
